/****************************************************************************
** Meta object code from reading C++ file 'chat_thread.h'
**
...
#error "The header file 'chat_thread.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ChatThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 30, 4)
    ...
    "ChatThread\0readData\0\0sendData\0quit\0"
};
...
const QMetaObject ChatThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ChatThread.data,
      qt_meta_data_ChatThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ChatThread.stringdata))
